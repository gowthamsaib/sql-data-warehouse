...
--
-- Purpose:
--   - Loads data from the Bronze layer into the Silver layer after cleaning and transformation.
--   - Applies data standardization, deduplication, enrichment, and error handling.
--   - Ensures reliable, analysis-ready data for the Gold layer and business intelligence usage.
--
-- How to Execute:
--   EXEC silver.load_silver;
--
-- Parameters: None
-- Output: Console messages indicating progress and load durations for each table.
--
-- Note:
--   - Assumes the Bronze layer is fully loaded and source files are available.
-- ========================================================================================
